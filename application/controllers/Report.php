...
class Report extends CI_Controller{
  ...
  public function data_submitted(){
       ...
       $data['input1'] = $this->input->post("Basic_inc");
       $data['input2'] = $this->input->post("Home_Rant");
       $data['input3'] = $this->input->post("Trans_val"); 
       $data['input4'] = $this->input->post("medical_cost");
       $data['input5'] = $this->input->post("other_income");
        ...
        echo $this->unit->run($test,$expected_result,$test_name); */
           ...
           $data['total']=$data['tax1']+$data['tax2']+$data['tax3']+ $data['tax4']+$data['tax5'];
                ...
                elseif (($data['input6'] =='Outside City')&& ( ($data['total']!=0) && ($data['total']<5000))){
                  ...
                  $this->form_validation->set_rules('Basic_inc', 'Basic income', 'trim');
                 $this->form_validation->set_rules('Home_Rant', 'Home_Rant', 'trim');
                 $this->form_validation->set_rules('Trans_val', 'Trans_val', 'trim');
